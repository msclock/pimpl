...
namespace pimpl {
	...
	class compressed_pair
		: private details::compressed_pair_imp<T1, T2,
											   details::compressed_pair_switch<
												   T1,
												   T2,
	...
	{
	private:
		using base = details::compressed_pair_imp<T1, T2,
												  details::compressed_pair_switch<
													  T1,
													  T2,
													  std::is_same<typename std::remove_cv<T1>::type, typename std::remove_cv<T2>::type>::value,
	...
	class compressed_pair<T, T>
		: private details::compressed_pair_imp<T,
											   T,
											   details::compressed_pair_switch<
												   T,
												   T,
	...
	{
	private:
		using base = details::compressed_pair_imp<T,
												  T,
												  details::compressed_pair_switch<
													  T,
													  T,
